...
class Product with _$Product {
  const factory Product({
    ...
    @Default(0) int freeshipRemoteDistrict,
    @Default(0) int yunfeixian,
    @Default(0) int goldSellers,
    @Default('') String reimgs,
    @Default('') String couponLink,
    @Default(0) int haitao,
    ...
    @Default(IListConst([])) IList<int> subcid,
    ...
    @Default([]) List<String> specialText
  }) = _Product;
