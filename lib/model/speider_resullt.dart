...
SpeiderWithTimeResult speiderWithTimeResultFromJson(String str) => SpeiderWithTimeResult.fromJson(json.decode(str));

String speiderWithTimeResultToJson(SpeiderWithTimeResult data) => json.encode(data.toJson());
