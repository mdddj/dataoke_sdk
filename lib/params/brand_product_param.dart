...
String brandProductParamToJson(BrandProductParam data) => json.encode(data.toJson());
...
class BrandProductParam {
  ...
  factory BrandProductParam.fromJson(Map<String, dynamic> json) => BrandProductParam(
